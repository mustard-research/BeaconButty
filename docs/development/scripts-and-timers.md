...
| `wan-watchdog.sh` | `wan-watchdog.sh` | `wan-watchdog.timer` (1 min) | WAN failure detection + evidence-based outage classification (nmcli-only since 2026-07-03; minutely + 10s escalation since 2026-08-30) |
